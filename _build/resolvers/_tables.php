...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('yasmartcaptcha', MODX_CORE_PATH . 'components/yasmartcaptcha/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/yasmartcaptcha/model/schema/yasmartcaptcha.mysql.schema.xml';
